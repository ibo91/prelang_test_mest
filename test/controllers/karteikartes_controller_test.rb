...
class KarteikartesControllerTest < ActionController::TestCase
  ...
  test "should create karteikarte" do
    assert_difference('Karteikarte.count') do
      post :create, karteikarte: { rueckseite: @karteikarte.rueckseite, titel: @karteikarte.titel, user_id: @karteikarte.user_id, vorderseite: @karteikarte.vorderseite }
    end
  ...
  test "should update karteikarte" do
    patch :update, id: @karteikarte, karteikarte: { rueckseite: @karteikarte.rueckseite, titel: @karteikarte.titel, user_id: @karteikarte.user_id, vorderseite: @karteikarte.vorderseite }
    assert_redirected_to karteikarte_path(assigns(:karteikarte))
  end
